...
void CopyPass::execute(const Device& device, RenderingResources& rr) {
    ...
    srang.setAspectMask(vk::ImageAspectFlagBits::eColor)
        .setBaseMipLevel(0)
        .setLevelCount(1)
        .setBaseArrayLayer(0)
        .setLayerCount(1);
    ...
    vk::ImageCopy copy;
    copy.setSrcOffset({}).setDstOffset({}).setExtent({ src.extent.width, src.extent.height, 1 });
    copy.srcSubresource.setAspectMask(srang.aspectMask)
        .setBaseArrayLayer(0)
        .setLayerCount(1)
        .setMipLevel(0);
    copy.dstSubresource.setAspectMask(srang.aspectMask)
        .setBaseArrayLayer(0)
        .setLayerCount(1)
        .setMipLevel(0);
    {
